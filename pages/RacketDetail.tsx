...
import { ArrowLeft, Check, ShoppingCart, ExternalLink, Zap, Activity, Info, Scale, Box, Layers, Ruler } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 space-y-8">
             ...
             <div>
                ...
                <div className="p-6 bg-zinc-900/50 border-l-2 border-padel-lime rounded-r-xl">
                    ...
                    >
                       <div className="flex items-center gap-4">
                          <div className="w-8 h-8 rounded bg-white flex items-center justify-center text-black font-bold text-xs uppercase">
                             {price.store.substring(0,2)}
                          </div>
                          <div>
                             <div className="font-bold text-zinc-200 text-sm uppercase tracking-wide">{price.store}</div>
