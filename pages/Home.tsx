...
import { ArrowRight, Zap, Target, BarChart2, Plus, ArrowUpRight, Award, ScanLine } from 'lucide-react';
    ...
    <div className="min-h-screen pt-20 bg-padel-black bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
          <div>
            <h2 className="text-zinc-400 font-mono text-xs uppercase tracking-widest mb-1">Bem-vindo à tua zona de treino</h2>
          ...
          <div className="flex gap-2">
            {!profileExists ? (
              ...
              >
                <Plus size={18} strokeWidth={3} /> Começar Perfil
              </Link>
            ) : (
               <Link 
                to="/match" 
              ...
              >
                <Target size={18} strokeWidth={3} /> Ver a minha Raquete
              </Link>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mb-12">
          ...
          <div className="md:col-span-8 relative group overflow-hidden rounded-2xl bg-zinc-900 border border-zinc-800">
            ...
            <div className="relative z-20 p-8 h-full flex flex-col justify-between min-h-[300px]">
              ...
              <div>
                <h3 className="text-3xl font-black text-white uppercase italic mb-2">Descobre a tua Raquete Ideal</h3>
                <p className="text-zinc-400 max-w-md mb-6 font-mono text-sm leading-relaxed">
                  Faz o nosso teste rápido e deixa que o nosso sistema te diga qual é a raquete perfeita para o teu estilo de jogo.
                </p>
                <Link to="/quiz" className="inline-flex items-center gap-2 text-white font-bold hover:text-padel-lime transition-colors uppercase tracking-wide text-sm border-b border-white/20 pb-1 hover:border-padel-lime">
                  Fazer o Teste Agora <ArrowRight size={16} />
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-4 flex flex-col gap-6">
            ...
            <Link to="/explore" className="flex-1 bg-zinc-900 rounded-2xl p-6 border border-zinc-800 hover:border-padel-lime/50 transition-colors group flex flex-col justify-between">
              <div className="flex justify-between items-start mb-4">
                <div className="p-3 bg-zinc-950 rounded-lg text-padel-lime group-hover:bg-padel-lime group-hover:text-padel-black transition-all">
                  <BarChart2 size={24} />
                </div>
                <span className="text-zinc-600 text-[10px] font-mono uppercase">Catálogo Completo</span>
              </div>
              <div>
                <div className="text-4xl font-black text-white font-mono">{RACKETS.length}</div>
                <div className="text-zinc-500 text-xs font-bold uppercase mt-1">Raquetes Analisadas</div>
              </div>
            </Link>

            <Link to="/scanner" className="flex-1 bg-zinc-900 rounded-2xl p-6 border border-zinc-800 hover:bg-zinc-800 transition-colors group flex flex-col justify-between">
              <div className="flex justify-between items-start">
                 <div className="p-3 bg-zinc-950 rounded-lg text-zinc-500 group-hover:text-padel-lime transition-colors">
                    <ScanLine size={24} />
                 </div>
                 <ArrowRight className="text-zinc-600 group-hover:text-white transition-colors" />
              </div>
              <div>
                 <div className="text-xl font-bold text-white uppercase italic">Saber mais sobre uma raquete?</div>
                 <div className="text-zinc-500 text-xs font-mono mt-1">IDENTIFICAR POR FOTO</div>
              </div>
            </Link>
          </div>
        </div>
        ...
        <div className="mb-6 flex items-center justify-between">
          <h3 className="text-xl font-black text-white uppercase italic flex items-center gap-2">
            ...
            <span className="flex items-center gap-2">
               As Mais Populares <Award size={18} className="text-padel-lime" />
            </span>
          </h3>
          <Link to="/explore" className="text-xs font-bold text-zinc-500 hover:text-white uppercase tracking-wider">Ver Catálogo</Link>
        </div>
